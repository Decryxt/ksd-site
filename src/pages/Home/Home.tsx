...
const BODY_JEWELRY_LAUNCH_DATE = "2026-05-31T09:00:00";
...
export default function Home() {
  ...
  return (
    <div className="-mt-16">
        ...
        <div className="mx-auto max-w-6xl px-6 py-24 md:py-28">
          ...
          >
            <div className="mx-auto max-w-4xl text-center">
              ...
              >
                Date For Katherine Sterling Designs At Miami Swim Week 2026.
              </motion.div>
              ...
              <motion.h3
                ...
                style={{ fontFamily: '"Perandory", serif', fontWeight: 400 }}
              >
                Miami Swim Week 2026 Is Approaching
              </motion.h3>
      ...
      >
        <div className="mx-auto max-w-6xl px-6 pb-32 pt-4 md:pt-6">
          <motion.div
